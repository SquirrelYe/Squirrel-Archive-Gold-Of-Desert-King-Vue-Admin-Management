        ...
        <div class="col-sm-12">
          <div class="btn-group pull-right">
            <button
              ...
              aria-expanded="false"
            >
              设置 <span class="m-l-5"><i class="fa fa-cog"></i></span>
            </button>
          </div>
            ...
            <div class="tiles-progress">
              <div class="m-t-20">
                <h5 class="text-uppercase text-white m-0">
                  上周新增人数 <span class="pull-right">23</span>
                </h5>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-6 col-sm-6 col-lg-3">
          <div class="mini-stat clearfix bg-purple bx-shadow">
            ...
            <div class="tiles-progress">
              <div class="m-t-20">
                <h5 class="text-uppercase text-white m-0">
                  上周新增赛事<span class="pull-right">59</span>
                </h5>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-6 col-sm-6 col-lg-3">
          <div class="mini-stat clearfix bg-primary bx-shadow">
            ...
            <div class="tiles-progress">
              <div class="m-t-20">
                <h5 class="text-uppercase text-white m-0">
                  上周交流次数 <span class="pull-right">136</span>
                </h5>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-6 col-sm-6 col-lg-3">
          <div class="mini-stat clearfix bg-success bx-shadow">
            ...
            <div class="tiles-progress">
              <div class="m-t-20">
                <h5 class="text-uppercase text-white m-0">
                  最近访问量 <span class="pull-right">1026</span>
                </h5>
              </div>
            </div>
          </div>
