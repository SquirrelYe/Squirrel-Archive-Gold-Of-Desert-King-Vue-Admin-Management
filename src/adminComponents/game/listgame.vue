                      ...
                      <div class="col-sm-6">
                        ...
                        >
                          <ul class="pagination" style="float: right">
                            ...
                            <li
                              class="paginate_button"
                              v-for="(item, index) in wsumPage"
                              :key="index"
                              :class="{ active: wcurrentPage == index }"
                            >
                              <a
                                href="javascript:void(0)"
                                @click="wswitchPage(index)"
                                >{{ ++index }}</a
                              >
                            </li>
                            <li
                              class="paginate_button next"
                              :class="{
                                disabled: wcurrentPage == wsumPage - 1,
                              }"
                            >
                              <a href="javascript:void(0)" @click="wnextPage()"
                                >下一页</a
                              >
                            </li>
                          </ul>
                      ...
                      <div class="col-sm-8">
                        ...
                        >
                          <ul class="pagination" style="float: right">
                            ...
                            <li
                              class="paginate_button"
                              v-for="(item, index) in msumPage"
                              :key="index"
                              :class="{ active: mcurrentPage == index }"
                            >
                              <a
                                href="javascript:void(0)"
                                @click="mswitchPage(index)"
                                >{{ ++index }}</a
                              >
                            </li>
                            <li
                              class="paginate_button next"
                              :class="{
                                disabled: mcurrentPage == msumPage - 1,
                              }"
                            >
                              <a href="javascript:void(0)" @click="mnextPage()"
                                >下一页</a
                              >
                            </li>
                          </ul>
              ...
              <tbody>
                <tr class="gradeX">
                  ...
                  <td>
                    <select
                      class="form-control"
                      v-model="editWeatherItem.whether_desert"
                    >
                      <option
                  ...
                  <td>
                    <select
                      class="form-control"
                      v-model="editWeatherItem.whether_oasis"
                    >
                      <option
                        v-for="(item, index) in weatherType"
                        :key="index"
                  ...
                  <td>
                    <select
                      class="form-control"
                      v-model="editWeatherItem.whether_tomb"
                    >
                      <option
                        v-for="(item, index) in weatherType"
                        :key="index"
                  ...
                  <td>
                    <select
                      class="form-control"
                      v-model="editWeatherItem.whether_village"
                    >
                      <option
                        v-for="(item, index) in weatherType"
                        :key="index"
                  ...
                  <td>
                    <select
                      class="form-control"
                      v-model="editWeatherItem.whether_gold"
                    >
                      <option
                        v-for="(item, index) in weatherType"
                        :key="index"
...
export default {
  ...
  methods: {
    ...
    confirmEditMapItem() {
      ...
      apis.editMap(w.id, w.land).then((res) => {
        console.log(res.data);
        this.map();
    ...
    // 删除比赛
    dele(del) {
      apis.delOneGameById(del.id).then((res) => {
    ...
    // 开始比赛
    startGame(item) {
      apis.updateOneGameById(item.id, 1).then((res) => {
        if (res.data[0] === 1) {
          this.init();
    ...
    // 结束比赛
    stopGame(item) {
      apis.updateOneGameById(item.id, 2).then((res) => {
        if (res.data[0] === 1) {
          this.init();
